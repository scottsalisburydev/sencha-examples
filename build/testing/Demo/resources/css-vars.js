...
(function (f) {
  ...
  return function () {
    ...
    1: [function (require, module, exports) {
      ...
      "./src/export/Base.js": 3,
      "./src/export/Output.js": 4,
      "./src/export/Runtime.js": 5,
      "./src/export/css/CssVariableManager.js": 6,
      "./src/export/parse/ValueParser.js": 7,
      "./src/export/type/Bool.js": 8,
      "./src/export/type/Color.js": 9,
      "./src/export/type/ColorHSLA.js": 10,
      "./src/export/type/ColorRGBA.js": 11,
      "./src/export/type/ColorStop.js": 12,
      "./src/export/type/FunctionCall.js": 13,
      "./src/export/type/LinearGradient.js": 14,
      "./src/export/type/List.js": 15,
      "./src/export/type/Literal.js": 16,
      "./src/export/type/Map.js": 17,
      "./src/export/type/Numeric.js": 18,
      "./src/export/type/ParentheticalExpression.js": 19,
      "./src/export/type/RadialGradient.js": 20,
      "./src/export/type/SourceBuilder.js": 21,
      "./src/export/type/Statics.js": 22,
      "./src/export/type/Text.js": 23,
      "./src/export/type/Type.js": 24,
      "./src/export/type/TypeVisitor.js": 25,
      "./src/export/type/Types.js": 26
    }],
    ...
    4: [function (require, module, exports) {
      ...
      function (_Base) {
        ...
        function Output() {
          ...
          _this = _possibleConstructorReturn(this, _getPrototypeOf(Output).call(this));
          _this.output = '';
          return _this;
        }
    ...
    5: [function (require, module, exports) {
      ...
      function (_Base2) {
        ...
        function Runtime(config) {
          ...
          _this2 = _possibleConstructorReturn(this, _getPrototypeOf(Runtime).call(this, config));
      ...
      "./type/Bool.js": 8,
      "./type/Color.js": 9,
      "./type/ColorRGBA.js": 11,
      "./type/List.js": 15,
      "./type/Literal.js": 16,
      "./type/Statics.js": 22,
      "./type/Text.js": 23,
      "./type/Type.js": 24,
      "./type/TypeVisitor.js": 25,
      "./type/Types.js": 26
    }],
    6: [function (require, module, exports) {
      ...
      "../Base.js": 3,
      "../Runtime.js": 5,
      "../parse/ValueParser.js": 7,
      "../type/SourceBuilder.js": 21
    }],
    ...
    9: [function (require, module, exports) {
      ...
      function (_Type2) {
        ...
        function Color() {
          ...
          return _possibleConstructorReturn(this, _getPrototypeOf(Color).call(this));
        }
        ...
        _createClass(Color, [{
          ...
          value: function adjust(color, component, amount) {
            var hsl = color.getHSLA().copy(),
                ...
                value = amount.value; //    if (component === 'saturation' && hsl.s === 0)  {
            //        return color.clone();
            //    }
            //
    ...
    10: [function (require, module, exports) {
      ...
      function (_Color) {
        ...
        function ColorHSLA(h, s, l, a) {
          ...
          _this4 = _possibleConstructorReturn(this, _getPrototypeOf(ColorHSLA).call(this));
          _this4.h = Color.constrainDegrees(h);
          _this4.s = s;
          _this4.l = l;
        ...
        _createClass(ColorHSLA, [{
          ...
          value: function fromRGBA(rgba) {
            ...
            var r = rgba.r / 255,
                ...
                h = 0,
                s = 0,
                l = 0.5 * (max + min); // min==max means achromatic (hue is undefined)
    ...
    11: [function (require, module, exports) {
      ...
      function (_Color2) {
        ...
        function ColorRGBA(r, g, b, a) {
          ...
          _this5 = _possibleConstructorReturn(this, _getPrototypeOf(ColorRGBA).call(this));
          _this5.r = Math.min(0xff, Math.max(0, r));
          _this5.g = Math.min(0xff, Math.max(0, g));
          _this5.b = Math.min(0xff, Math.max(0, b));

          if (a !== undefined) {
            _this5.a = Math.min(1.0, Math.max(0.0, a));
          }
        ...
        _createClass(ColorRGBA, [{
          ...
          value: function stringify() {
            var me = this,
                ...
                b = round(me.b),
                a = me.a,
                stringified = ''; // If there is no transparency we will use hex value
          ...
          colorChars.forEach(function (short2) {
            ...
            colorChars.forEach(function (short3) {
              ...
              if (shortMap[longName]) {
                ...
                shortName = curr.length > shortName.length ? shortName : curr; //if(curr.indexOf("#") === 0) {
    ...
    12: [function (require, module, exports) {
      ...
      function (_Type3) {
        ...
        function ColorStop(color, stop) {
          ...
          _this6 = _possibleConstructorReturn(this, _getPrototypeOf(ColorStop).call(this));
          _this6.color = color;
          _this6.stop = stop;
          return _this6;
        }
    ...
    13: [function (require, module, exports) {
      ...
      function (_Type4) {
        ...
        function FunctionCall(name, args) {
          ...
          _this7 = _possibleConstructorReturn(this, _getPrototypeOf(FunctionCall).call(this));
          _this7.name = name;
    ...
    14: [function (require, module, exports) {
      ...
      function (_Type5) {
        ...
        function LinearGradient(position, stops) {
          ...
          _this8 = _possibleConstructorReturn(this, _getPrototypeOf(LinearGradient).call(this));
        ...
        _createClass(LinearGradient, [{
          ...
          value: function operate(operation, right) {
            ...
            return _get(_getPrototypeOf(LinearGradient.prototype), "operate", this).call(this, operation, right);
          }
        }, {
          key: "supports",
    ...
    15: [function (require, module, exports) {
      ...
      function (_Type6) {
        ...
        function List(items, separator) {
          ...
          _this9 = _possibleConstructorReturn(this, _getPrototypeOf(List).call(this));
          _this9.items = items || [];
          _this9.separator = typeof separator === 'undefined' ? ' ' : separator;
          return _this9;
        }
        ...
        _createClass(List, [{
          ...
          value: function operate(operation, right) {
            ...
            return _get(_getPrototypeOf(List.prototype), "operate", this).call(this, operation, right);
          }
        }, {
          key: "supports",
          value: function supports(prefix) {
          ...
          value: function getItems() {
            return this.items; // return Fashion.filter(this.items, (item) => {
    ...
    16: [function (require, module, exports) {
      ...
      function (_Type7) {
        ...
        function Literal(value) {
          ...
          _this10 = _possibleConstructorReturn(this, _getPrototypeOf(Literal).call(this));
          _this10.value = value;
          return _this10;
        }
      ...
      function (_Literal) {
        ...
        function FashionNull(value) {
          ...
          return _possibleConstructorReturn(this, _getPrototypeOf(FashionNull).call(this, value || null));
        }
    ...
    17: [function (require, module, exports) {
      ...
      function (_List) {
        ...
        function Map(pairs) {
          ...
          _this11 = _possibleConstructorReturn(this, _getPrototypeOf(Map).call(this, pairs));
          _this11.map = {};

          if (pairs) {
            for (var i = 0; i < pairs.length - 1; i += 2) {
              var key = _this11.toKey(pairs[i]),
                  value = pairs[i + 1];
    ...
    18: [function (require, module, exports) {
      ...
      function (_Type8) {
        ...
        function Numeric(value, unit, numeratorUnits, denominatorUnits) {
          ...
          _this12 = _possibleConstructorReturn(this, _getPrototypeOf(Numeric).call(this));
          _this12.value = value;
          _this12.unit = unit;

          if (unit && !numeratorUnits) {
            _this12.numeratorUnits = [unit];
          } else {
            _this12.numeratorUnits = numeratorUnits || [];
          }

          _this12.denominatorUnits = denominatorUnits || [];
          return _this12;
        }
        ...
        _createClass(Numeric, [{
          ...
          value: function stringify() {
            ...
            var value = this.value,
                valStr; // prevent 0.020000000000000004 type numbers in output

            valStr = Math.round(value * 100000) / 100000 + ''; //unitStr = valStr === '0' ? '' : this.getUnitStr();
          ...
          value: function operate(operation, right) {
            ...
            return _get(_getPrototypeOf(Numeric.prototype), "operate", this).call(this, operation, right);
          }
        }, {
          key: "tryNormalize",
    ...
    19: [function (require, module, exports) {
      ...
      function (_Type9) {
        ...
        function ParentheticalExpression(value) {
          ...
          _this13 = _possibleConstructorReturn(this, _getPrototypeOf(ParentheticalExpression).call(this));
          _this13.value = value;
          return _this13;
        }
    ...
    20: [function (require, module, exports) {
      ...
      function (_Type10) {
        ...
        function RadialGradient(position, shape, stops) {
          ...
          _this14 = _possibleConstructorReturn(this, _getPrototypeOf(RadialGradient).call(this));
        ...
        _createClass(RadialGradient, [{
          ...
          key: "gradientPoints",
          value: function gradientPoints(position) {//position = (position.type === 'list') ? position.clone() : new Fashion.List([position]);
    ...
    21: [function (require, module, exports) {
      ...
      function (_TypeVisitor) {
        ...
        function SourceBuilder(cfg) {
          ...
          _this15 = _possibleConstructorReturn(this, _getPrototypeOf(SourceBuilder).call(this, cfg));
          _this15.nullFound = false;
          return _this15;
        }
    ...
    23: [function (require, module, exports) {
      ...
      function (_Literal2) {
        ...
        function Text(value, quoteChar) {
          ...
          _this16 = _possibleConstructorReturn(this, _getPrototypeOf(Text).call(this, value));

          if (quoteChar !== undefined) {
            if (Text.preferDoubleQuotes && quoteChar === '') {
              _this16.quoteChar = '';
            } else {
              _this16.quoteChar = quoteChar;
            }
          }
        ...
        _createClass(Text, [{
          ...
          key: "slice",
          value: function slice(start, end) {
            return new Text(_get(_getPrototypeOf(Text.prototype), "slice", this).call(this, start, end).value, this.quoteChar);
          }
        }, {
          key: "toUpperCase",
          value: function toUpperCase() {
          ...
          key: "insert",
          value: function insert(str, startVal) {
            return new Text(_get(_getPrototypeOf(Text.prototype), "insert", this).call(this, str, startVal).value, this.quoteChar);
          }
        }], [{
          key: "tryCoerce",
          value: function tryCoerce(obj) {
    ...
    26: [function (require, module, exports) {
      ...
      "./ColorStop.js": 12,
      "./FunctionCall.js": 13,
      "./LinearGradient.js": 14,
      "./List.js": 15,
      "./Literal.js": 16,
      "./Map.js": 17,
      "./Numeric.js": 18,
      "./ParentheticalExpression.js": 19,
      "./RadialGradient.js": 20,
      "./Text.js": 23
    }]
  }, {}, [1])(1);
});
...
__rt_setDynamic("$blue", __rt_getGlobalDefault("$blue") || __ColorRGBA.fromHex("#00a1dd"), 1);
__rt_setDynamic("$base-color", __rt_getGlobalDefault("$base_color") || __rt_get("$blue"), 2);
...
__rt_setDynamic("$accent_color_name", __rt_getGlobalDefault("$accent_color_name") || new __Text("grey", "'"), 13);
...
__rt_setDynamic("$alert-pressed-color", __rt_getGlobalDefault("$alert_pressed_color") || (__rt_test(__rt_get("$dark_mode")) ? __rt_box(__rt.registered.darken.apply(__rt.registered, __rt_applySpreadArgs([
    ...
    __rt_get("$alert_color"), 
    new __Numeric(15, "%")])))), 23);
__rt_setDynamic(__strings._, __rt_getGlobalDefault(__strings._) || (__rt_test(__rt_get("$dark_mode")) ? __ColorRGBA.fromHex("#ffffff") : __ColorRGBA.fromHex("#111111")), 24);
...
__rt_setDynamic("$background-color", __rt_getGlobalDefault("$background_color") || (__rt_test(__rt_get("$dark_mode")) ? __ColorRGBA.fromHex("#303030") : __ColorRGBA.fromHex("#fafafa")), 34);
__rt_setDynamic("$alt-background-color", __rt_getGlobalDefault("$alt_background_color") || (__rt_test(__rt_get("$dark_mode")) ? __ColorRGBA.fromHex("#3a3a3a") : __ColorRGBA.fromHex("#f5f5f5")), 35);
__rt_setDynamic("$reverse-background-color", __rt_getGlobalDefault("$reverse_background_color") || (__rt_test(__rt_get("$dark_mode")) ? __ColorRGBA.fromHex("#fafafa") : __ColorRGBA.fromHex("#303030")), 36);
__rt_setDynamic("$reverse-alt-background-color", __rt_getGlobalDefault("$reverse_alt_background_color") || (__rt_test(__rt_get("$dark_mode")) ? __ColorRGBA.fromHex("#f5f5f5") : __ColorRGBA.fromHex("#3a3a3a")), 37);
__rt_setDynamic("$overlay-color", __rt_getGlobalDefault("$overlay_color") || (__rt_test(__rt_get("$dark_mode")) ? __rt_box(__rt.registered.rgba.apply(__rt.registered, __rt_applySpreadArgs([
    ...
    __udf, 
    __udf])))), 38);
__rt_setDynamic("$content-padding", __rt_getGlobalDefault("$content_padding") || new __Numeric(16, "px"), 39);
},
 {
	":root": [
		"dark-mode",
